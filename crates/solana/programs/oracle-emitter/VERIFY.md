# Verifying the oracle-emitter program
...
solana-verify get-executable-hash target/deploy/oracle_emitter.so
...
- The `declare_id!()` in [programs/oracle-emitter/src/lib.rs](programs/oracle-emitter/src/lib.rs)

...
export type DeployBasejumpParams = WalletContext & {
  wormholeId: number;
...
export type DeployBasejumpResult = {
...
export async function deployBasejump(
  params: DeployBasejumpParams,
): Promise<DeployBasejumpResult> {

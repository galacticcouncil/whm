...
import {INearIntentsRouter} from "./interfaces/INearIntentsRouter.sol";

/// @title NearIntentsRouter — Ethereum adapter between Basejump and NEAR Intents (Defuse / OneClick)
...
contract NearIntentsRouter is Initializable, UUPSUpgradeable, INearIntentsRouter {

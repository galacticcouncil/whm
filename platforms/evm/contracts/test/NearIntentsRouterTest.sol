...
import {NearIntentsRouter} from "../src/NearIntentsRouter.sol";
import {INearIntentsRouter} from "../src/interfaces/INearIntentsRouter.sol";
...
contract NearIntentsRouterTest is Test {
    NearIntentsRouter public router;
    ...
    function setUp() public {
        ...
        NearIntentsRouter impl = new NearIntentsRouter();
        ERC1967Proxy proxy = new ERC1967Proxy(
            address(impl),
            abi.encodeCall(NearIntentsRouter.initialize, (landing))
        );
        router = NearIntentsRouter(address(proxy));
    }
    ...
    function testForwardsAssetToDepositAddress() public {
        ...
        emit INearIntentsRouter.IntentForwarded(intentId, address(usdc), depositAddress, amount);
    ...
    function testForwardsAnyAsset() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit INearIntentsRouter.IntentForwarded(intentId, address(otherToken), depositAddress, amount);
    ...
    function testRevertsWhenSenderNotLanding() public {
        ...
        vm.prank(stranger);
        vm.expectRevert(abi.encodeWithSelector(INearIntentsRouter.NotBasejumpLanding.selector, stranger));
    ...
    function testRevertsOnMalformedData() public {
        ...
        vm.prank(landing);
        vm.expectRevert(INearIntentsRouter.MalformedData.selector);
    ...
    function testRevertsOnZeroDepositAddress() public {
        ...
        vm.prank(landing);
        vm.expectRevert(INearIntentsRouter.InvalidDepositAddress.selector);
        router.onBasejumpReceive(address(usdc), 1_000e6, data);
    }
    ...
    function testSweep() public {
        ...
        emit INearIntentsRouter.Swept(address(usdc), to, 500e6);
    ...
    function testSweepRevertsUnauthorized() public {
        vm.prank(stranger);
        vm.expectRevert(INearIntentsRouter.NotOwner.selector);

...
/**
 * NEAR NTT for NEAR — `wrap.near` locked on NEAR, burned and minted on Hydration.
 ...
 *
 * `emitter` is `sha256(<001 nttAccount>)` — read it from deployments/<context>/near-ntt-near.json.
 *
 ...
 *
 * Env file: migrations/envs/<context>/near-ntt-near.env
 */
const config: MigrationConfig = {
  name: "near-ntt-near",
  description: "Deploy the NEAR NTT hub for wNEAR",
  pks: ["PK_NEAR"],

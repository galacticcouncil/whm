...
const step: MigrationStep = {
  name: "007-set-landing@proxy",
  description: "Register existing Hydration BasejumpLanding on BasejumpProxy for source chain",
  action: async (ctx) => {
    ...
    if (!wormholeId) throw new Error("Missing wormholeId from 001-deploy-basejump");

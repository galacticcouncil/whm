...
contract OracleDispatcherTest is Test, MockWormhole {
    ...
    function setUp() public {
        OracleDispatcher impl = new OracleDispatcher();
        ERC1967Proxy proxy =
            new ERC1967Proxy(address(impl), abi.encodeCall(OracleDispatcher.initialize, (wormhole)));
        dispatcher = OracleDispatcher(address(proxy));

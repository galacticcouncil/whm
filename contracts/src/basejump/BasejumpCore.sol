...
import {IBasejumpCore} from "./interfaces/IBasejumpCore.sol";

/// @title BasejumpCore — Shared logic for Basejump variants
...
abstract contract BasejumpCore is MessageReceiver, IBasejumpCore {
    ...
    function _processMessage(IWormhole.VM memory vm) internal virtual override {
        IBasejumpCore.TransferPayload memory transfer = abi.decode(vm.payload, (IBasejumpCore.TransferPayload));
